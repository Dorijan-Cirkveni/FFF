        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentRequests_AspNetUsers_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppointmentRequests_AspNetUsers_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_AspNetUsers_ForId",
                        column: x => x.ForId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Lessons_AspNetUsers_FromId",
                        column: x => x.FromId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAppointment", x => new { x.AppointmentsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_StudentAppointment_Appointments_AppointmentsId",
                        column: x => x.AppointmentsId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentAppointment_AspNetUsers_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_ApprovedById",
                table: "AppointmentRequests",
                column: "ApprovedById");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_RequestedById",
                table: "AppointmentRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_ForId",
                table: "Lessons",
                column: "ForId");

            migrationBuilder.CreateIndex(
                name: "IX_Lessons_FromId",
                table: "Lessons",
                column: "FromId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAppointment_StudentsId",
