...
using SkolaGitareAPI.Data.Repositories;
using SkolaGitareAPI.Data.Repositories.Interfaces;
using SkolaGitareAPI.Mappings;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(swagger =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Skola Gitare API",
                    Description = "Backend za školu gitare"
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IDbInitializer dbInitializer)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SkolaGitareAPI v1"));
            }
